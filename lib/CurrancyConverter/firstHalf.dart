...
class FirstHalf extends StatelessWidget {
  ...
  FirstHalf({this.firstCurrencyFunction,this.secondCurrencyFunction,this.textFieldFunction});
  @override
...
class FirstHalfLength extends StatelessWidget {
  ...
  FirstHalfLength({this.firstLenghtFunction,this.secondLenghtFunction,this.textFieldFunctionLenght});
  @override
  Widget build(BuildContext context) {
    // TODO: implement build
    return Container(
...
class FirstHalfWeight extends StatelessWidget {
  ...
  FirstHalfWeight({this.firstWeightFunction,this.secondWeightFunction,this.textFieldFunctionWeight});
  @override
  Widget build(BuildContext context) {
    // TODO: implement build
    return Container(
